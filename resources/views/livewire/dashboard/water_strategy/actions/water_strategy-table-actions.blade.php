<div class="flex justify-end items-center space-x-2">
    <a href="{{ route('dashboard.program.delete', [ 'community_id' => $community_id, 'id' => $id ]) }}" class="mr-1 hover:text-project-error disabled"><x-icons.delete-trash></x-icons.delete-trash></a>
