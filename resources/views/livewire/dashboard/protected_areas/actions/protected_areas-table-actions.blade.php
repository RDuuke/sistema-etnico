<div class="flex justify-end items-center space-x-2">
    <a href="{{ route('dashboard.protected-areas.delete', [ 'community_id' => $community_id, 'id' => $id ]) }}" class="mr-1 hover:text-project-error"><x-icons.delete-trash></x-icons.delete-trash></a>
