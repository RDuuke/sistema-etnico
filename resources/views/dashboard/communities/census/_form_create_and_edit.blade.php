        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-2">
                ...
                <input placeholder="{{__('app.number_of_families')}}" type="number" name="number_of_families" id="number_of_families" 
                        value="{{ old('number_of_families', $community_census->number_of_families ?? '') }}" class="input-form">
            ...
            <div class="sm:col-span-2">
                ...
                <input placeholder="{{__('app.number_of_people')}}" type="number" name="number_of_people" id="number_of_people"
                    value="{{ old('number_of_people', $community_census->number_of_people ?? '') }}" class="input-form">
            ...
            <div class="sm:col-span-2">
                ...
                <input placeholder="{{__('app.year')}}" type="number" name="year" id="year"
                    value="{{ old('year', $community_census->year ?? '') }}" class="input-form" maxlength="4">
