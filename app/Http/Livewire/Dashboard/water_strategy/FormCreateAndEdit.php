...
final class FormCreateAndEdit extends Component
{
    ...
    public function mount(string $community_id, $water_strategy_id)
    {
        ...
        $this->water_strategy       = new Programs();
        ...
        if ($this->water_strategy_id) {
            ...
            $this->water_strategy          = Programs::find($this->water_strategy_id);
        }
    ...
    public function save() {
        ...
        try {
            if ($this->add_water_strategy) {
                ...
                //$this->repository->create($this->water_strategy); //TODO Pendiente implementar logica
